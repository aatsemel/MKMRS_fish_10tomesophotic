...
my_data <- read_csv(here("R.generated.Data","Fish.FactorsGrp.wis.csv") ) #change to your file directory
...
###Using dataframes from "Ordinations" RMD
```{r}

temp_null_qs <- oecosimu(hlge_trans_data, nestfun="nestedtemp",method="quasiswap",nsimul = 100)
temp_null_qs
