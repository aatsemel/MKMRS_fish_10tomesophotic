...
autoplot(PCA_helg_log_results,
         ...
         data = my_data,
         colour = 'depth_category', font_size = 14) +theme_classic()
...
rda_results <- rda(helg_log_trans_data ~  site_id +season + visibility + Algae +Soft.Substrate + VerRelief + Slope + Curvature + mean_depth + Sponge + Bryozoan  ,
                data = my_data,
                na.action = na.omit) 
...
plot.new()
plot(rda_results) # plot RDA  display = "sites"
...
anova.cca(rda_results2,by = "term")
